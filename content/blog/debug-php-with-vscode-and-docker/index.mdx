...
date: '2020-02-26'
description: "Debugging PHP with Xdebug using VS Code as your IDE. These are the step-by-step instructions on how I got Xdebug working with VS Code and Docker."
teaser_image: './images/debug.jpg'
---

This post was inspider by a specific [stackoverflow comment](https://stackoverflow.com/a/52805763/5562316). It was really helpful to getting this setup working as I needed it.
...
[Chrome](https://chrome.google.com/webstore/detail/xdebug-helper/eadndfjplgieldjbigjakmdgkmoaaaoc) and [Firefox](https://addons.mozilla.org/fi/firefox/addon/xdebug-helper-for-firefox/) versions available.
