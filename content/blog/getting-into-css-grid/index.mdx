...
date: '2019-07-31'
description: "From the first time I heard about flexbox, I was hooked on it. It was finally really enjoyable to create layouts with CSS without hacking with floats and other methods. I haven't allocated time to really get into Grid, because of flexbox - but that is about to change."
teaser_image: './images/grid.jpg'
---
...
<WidgetImage src="./images/grid-caniuse-support.png" alt="A table that showcases CSS grid support in various browsers" />
