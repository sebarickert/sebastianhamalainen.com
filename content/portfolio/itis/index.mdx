...
I mainly built the Frontend aspects of the website and configured the Groups -module functionality to work with different kind of permissions and users. Also basic site building.
...
Frontend building has tools such as Gulp for compiling our SCSS to CSS and JavaScript to ES5.
