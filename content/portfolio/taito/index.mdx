...
stack: ['Drupal', 'Drupal Commerce', 'JavaScript', 'CSS / SCSS']
---

import WidgetImage from '../../../src/components/widget/image/image';

<WidgetImage src="./images/ss-taito.jpg" alt="A screenshot of the showcases website" />

## What did I do?

Initialized the Drupal 8  with commerce installations custom theme and built the whole frontend. It took me just under a week to finish building.
