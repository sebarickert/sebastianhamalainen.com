...
Majority of my work was frontend related, e. g. making it responsive, compatible with browsers and do basic styling.


## Tech stack used in this project

The site is built on Drupal 8. Building the Frontend we used tools such as grunt for compiling our SCSS to CSS and JavaScript to ES5.
